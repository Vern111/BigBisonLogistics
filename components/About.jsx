	...
	return (
		...
		<div class=' place-items-center m-12 grid h-full lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 sm:grid-rows-[min-content,1fr]'>
			<div class='  sm:col-span-1'>
				...
				<br />
				<p>
					Every team member is personally vetted by the founder before
					they are trained by our team to ensure new teammates have
					values aligned with ours; Integrity, Morals, Flexibility,
					and Extreme Ownership are building blocks of our culture of
					service to others.{' '}
				</p>
