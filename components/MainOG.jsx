					...
					<div class=' m-2 mr-36 sm:col-span-2'>
						<div>
							...
							<p className=' pl-16 text-[#F7F7F7] max-w-[100%] m-auto'>
								Our drive to succeed is wrapped in our
								philosophy to serve others before self. We're
								not in business to build our follower base. We
								work to make your life more normal by minimizing
								your stressors and mitigating risks whether seen
								or unseen.
							</p>
						</div>
