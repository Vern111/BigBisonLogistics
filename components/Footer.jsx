  ...
  return (
		<>
			<div className='bg-[#212529]  h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-20'>
				<div className='p-5 '>
					<ul>
						<p className=' text-btext font-bold text-3xl pb-6'>
							About Us
						</p>
						<p className='text-btext text-sm font-semibold'>
							...
							individuals life occur when they become prominent or
							successful.
						</p>
				...
				<div className='p-5'>
					<ul>
						...
						<p className='text-btext text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer'>
							More than just a quick saying, but one of the
							driving forces behind our success.
						</p>
						<p className='text-btext text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer'>
							<i>Always Adapting</i> signifies our pledge to stay
							vigilant to change. Chosing the path of greater
							success over relative ease.
						</p>
					</ul>
				</div>
				<div className='p-5'>
